...
kk
ll
rm -rf meson_build/ learn hello.cpp cmake_install.cmake cmake_stuff.txt Makefile a.out CMakeCache.txt CMakeLists.txt .travis.yml .cmake-format.yaml 
ls
ll
...
cd interface/
ls
meson init --language=cpp --name=interface --version=0.1
ll
meson setup build
ls
...
mkdir src
cd src/
git clone https://github.com/maxrousseau/portfolio.git
cd
cd doc/mus/
ls
cd ambient/
youtube-dl --help
man youtube-dl
youtube-dl -f 140 https://www.youtube.com/watch?v=GvaC6cIrntI&t=18s
cd
cd src/
ll
ll
...
cd themes/
ll
-rwxrwxr-x   1 max            max       4340 2020-06-02 17:30 base16-edge-dark.rasi
cd
ls
ll
ll .virtualenvs/
ll .virtualenvs/ml_all/
ll .virtualenvs/ml_all/bin/
-rwxrwxr-x   1 max            max       234 2020-08-16 13:26 pyrsa-verify
virtualenv create
ll .virtualenvs/
virtualenv -h
...
ESS and elpy are pretty slow, consider removing or alternatives...
